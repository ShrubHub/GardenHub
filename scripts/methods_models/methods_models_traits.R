...
summary(LL_method_mod_nospp) # fixed-effect model matrix is rank deficient so dropping 1 column / coefficient
plot(LL_method_mod_nospp)
qqnorm(resid(LL_method_mod_nospp))
qqline(resid(LL_method_mod_nospp))
